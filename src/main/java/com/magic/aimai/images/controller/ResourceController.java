package com.magic.aimai.images.controller;

import com.magic.aimai.business.util.FileUpload;
import com.magic.aimai.business.util.StatusConstant;
import com.magic.aimai.images.util.CommonUtil;
import com.magic.aimai.images.util.ImageBase64Utils;
import com.magic.aimai.images.util.RotateImage;
import com.magic.aimai.images.util.ViewData;
...
//                        //上传logo不进此方法
//                        if (!"logo".equals(type) && !"1".equals(type)) {
